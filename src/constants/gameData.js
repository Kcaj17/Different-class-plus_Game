...
const ROLE_TEMPLATES = [
  ...
  // 3 General Citizens (พนักงาน / แรงงานทั่วไป)
  {
    ...
    description: 'มีเงินเดือนประจำและใช้สมาร์ตโฟน มีสิทธิร่วมโครงการคนละครึ่ง 60/40 และสามารถเลือกเข้าคอร์สอบรมเพื่อขอปรับขึ้นเงินเดือนได้',
    avatar: '👔',
    initialCash: 25000,
    baseIncome: 22000,
    fixedExpense: 14000,
...
const ROUNDS_DATA = [
  ...
  {
    round: 3,
    chapterName: 'รอบที่ 3: นโยบายไทยช่วยไทยพลัส (60/40) และสวัสดิการแห่งรัฐ',
    subTitle: 'รัฐบาลกู้เงิน 1.75 แสนล้านบาท อัดฉีดกำลังซื้อและช่วยจ่ายค่าครองชีพ',
    lore: 'รัฐบาลประกาศใช้นโยบายกระตุ้นเศรษฐกิจ "ไทยช่วยไทยพลัส (60/40)" โดยรัฐช่วยจ่าย 60% และประชาชนจ่ายเอง 40% ผ่านแอปพลิเคชัน พร้อมทั้งโอนเงินช่วยเหลือให้แก่ผู้ถือบัตรสวัสดิการแห่งรัฐ 1,000 บาท/เดือน ช่วยเพิ่มกำลังซื้อให้ประชาชนและสร้างรายได้ให้ร้านค้าในชุมชน',
