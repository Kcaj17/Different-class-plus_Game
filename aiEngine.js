...
const DND_DM_SYSTEM_PROMPT = `คุณคือระบบวิเคราะห์และบรรยายผลกระทบทางเศรษฐกิจ ในเกมจำลองนโยบายเศรษฐกิจ "ไทยช่วยไทยพลัส 60/40"
หน้าที่ของคุณคือ:
...
async function generateRoundDynamicActions(roundNumber, roundInfo = {}, districtMacro = {}) {
  ...
  const prompt = `คุณคือนักออกแบบนโยบายและกลยุทธ์ทางเศรษฐกิจในเกมจำลอง "ไทยช่วยไทยพลัส 60/40"
